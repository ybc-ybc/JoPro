...
def crop_pc(coord, feat, label, mask, split='train', voxel_max=None, shuffle=True):
    crop_idx = None
    ...
    return coord.astype(np.float32), feat.astype(np.float32), label.astype(np.int64), mask[crop_idx]
